...
export function initForms() {
    const contactForms = Array.from(document.getElementsByClassName('contactform'));
...
function buildFormParams(form) {
    ...
    fields.forEach(({ selector, paramName }, index) => {
...
function setFormStatus(form, status, additionalStatus) {
    Object.values(FORM_STATUS).forEach((statusClass) => {
