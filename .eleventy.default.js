...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addLiquidFilter( 'unprefixedHumanReadableUrl', function(url) {
    ...
    url = url.replace(/^github.com/, '<img class="logo-inline no-print" src="img/logo-github.svg" witdh="32" height="32" alt="github.com"><span class="only-print">github.com</span>');
    url = url.replace(/^store.shopware.com(?:\/en)*/, '<img class="logo-inline no-print" src="img/logo-shopware.svg" witdh="32" height="32" alt="store.shopware.com"><span class="only-print">store.shopware.com</span>');
    url = url.replace(/\/$/, '');
    return url;
  });
