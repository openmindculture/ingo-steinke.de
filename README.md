...
```
exiftool -Title="CV Ingo Steinke - Frontend-Web-Entwickler" -Author="Ingo Steinke" -Subject="Freelance-Web-Entwickler mit Frontend-Fokus" -Keywords="Frontend-Entwickler, Web-Entwicklung, Webentwicklung, Web Development, JavaScript, TypeScript, React, HTML, CSS, SCSS, PHP, npm, Git, Cypress, Accessibility, Barrierefreiheit, Freelancer, Remote" Ingo-Steinke-Frontend-Web-Entwickler-CV-YYYY-MM.pdf
```
